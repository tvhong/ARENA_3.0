...
class AutoencoderArgs:
    ...
    wandb_project: str | None = "vhong-day5-autoencoder"
...
class AutoencoderTrainer:
    ...
    def training_step(self, img: Tensor) -> Tensor:
        ...
        loss = t.nn.MSELoss(reduction="mean")(output, img)
        loss.backward()
    ...
    def train(self) -> Autoencoder:
        ...
        # YOUR CODE HERE - iterate over eeochs, and train your model
        for epoch in range(self.args.epochs):
            ...
            for img, _label in progress_bar:
                ...
                progress_bar.set_description(f"{epoch=:02d}/{self.args.epochs}, {loss=:.4f}, step={self.step:05d}")
